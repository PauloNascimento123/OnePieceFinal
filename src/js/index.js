// Teste
//window.alert("Estou linkado")

// TEXTO COMENTADO DO QUE PRECISAMOS FAZER:
...
const botoes = document.querySelectorAll('.botao'); // Selecionado os elementos da classe botao.
